---
description: "投资论文漂移检测：分清事实变化与措辞变化"
agent: build
---

## OpenCode adapter note

This skill is generated from `skills/thesis-drift.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
