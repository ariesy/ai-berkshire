---
description: "组合管理：从\"研究公司\"到\"管理组合\""
agent: build
---

## OpenCode adapter note

This skill is generated from `skills/portfolio-review.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
