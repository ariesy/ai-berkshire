---
description: "investment-memo-craft"
agent: build
---

## OpenCode adapter note

This skill is generated from `skills/investment-memo-craft.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
