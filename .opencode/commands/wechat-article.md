---
description: "微信公众号文章：作者-编辑-读者三Agent协作"
agent: build
---

## OpenCode adapter note

This skill is generated from `skills/wechat-article.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
