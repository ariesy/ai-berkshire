---
description: "投资研究：巴菲特-芒格-段永平-李录 四大师综合分析框架"
agent: build
---

## OpenCode adapter note

This skill is generated from `skills/investment-research.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
