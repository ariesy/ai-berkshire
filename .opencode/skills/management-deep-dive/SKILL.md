...
description: "管理层纵深研究：买股票就是买人"
---

## OpenCode adapter note

This skill is generated from `skills/management-deep-dive.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
