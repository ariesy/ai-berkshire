...
description: "供应链瓶颈猎手：AI驱动的全球产业链瓶颈套利"
---

## OpenCode adapter note

This skill is generated from `skills/bottleneck-hunter.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
