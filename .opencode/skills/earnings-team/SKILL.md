---
name: earnings-team
description: "财报精读团队：四大师并行解读 + 公众号发布"
---

## OpenCode adapter note

This skill is generated from `skills/earnings-team.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
