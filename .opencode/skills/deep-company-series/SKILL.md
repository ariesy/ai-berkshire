...
description: "看懂XX公司（深度公司系列）：3-8 篇长文拆一家公司"
---

## OpenCode adapter note

This skill is generated from `skills/deep-company-series.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
