...
description: "巴菲特价值投资买入前 Checklist"
---

## OpenCode adapter note

This skill is generated from `skills/investment-checklist.md` so Claude Code, Codex, and OpenCode users share one canonical workflow.
